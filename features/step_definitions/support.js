...
Support.prototype.get = function(url, callback){
    protractor.browser.get(url).then(function(result) {
        callback(result)
    });
};
...
Support.prototype.findElementByCss = function(sut, css, callback) {
    sut.browser.findElement(sut.by.css(css)).then(function (result) {
        callback(result)
    });
};
